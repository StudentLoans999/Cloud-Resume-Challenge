Following the CRC Guidebook, the first step is to set up an AWS personal development environment, and there are two ways of doing that (original, professional).
